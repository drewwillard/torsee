...
function BroadwayStreet({ businesses, setSelectedBusinessId, setView, setBusinessView, handleViewBusinessDetails }) {
  ...
  function updateDistrictNamePosition() {
    ...
    const broadwayStreet = mainStreetRef.current;
    const districtName = districtNameRef.current;
    const businessRect = broadwayStreet.getBoundingClientRect();
    ...
    <div className="broadway-street main-street" ref={mainStreetRef}>
      ...
      <div className="torc-map-container">
        <div className="map-wrapper map-box">
          ...
          <div className="map-marker broadway-marker">X</div>
        </div>
      </div>
      <div className="broadway-district-name district-name" ref={districtNameRef}>Broadway</div>
